...
def show():
    ...
    for time, group in grouped:
        ...
        accumulated_targets.extend(targets)
        ...
        frame = go.Frame(data=[go.Sankey(
            ...
            link=dict(
                source=accumulated_sources,  # 누적된 source 리스트
                target=accumulated_targets,  # 누적된 target 리스트
                value=accumulated_values,    # 누적된 value 리스트
